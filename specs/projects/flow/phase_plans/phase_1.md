...
1. Create the root package layout and foundational public values: typed IDs, statuses/outcomes, execution handles, command metadata, safe sentinel/structured errors, `Permanent`, and `RetryAfter`.
