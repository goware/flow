...
# Plan 13 claim projection evidence

Phase 1 of Plan 13 widens the one-per-batch claim-head SELECT from
...
regression beyond noise. Plan 13 STOP condition 1 does not apply and the
